...
class SAC_Discrete():
    def __init__(self, observation_shape, num_actions, hidden_dim, gamma=0.9, lr=3e-4, automatic_entropy_tuning=True, visual=False, cuda=False, tau=0.005):
        ...
        self.policy = CategoricalPolicy(observation_shape, num_actions, hidden_dim, visual=visual).to(device=self.device)
